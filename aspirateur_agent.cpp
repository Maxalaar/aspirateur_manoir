...
//    qDebug() << "la position de la salle fonction : " << this->tableau[0][0].position_x;
    ...
    this->liste_action = exploration_non_informees(this->tableau);
...
QVector<action_type> Aspirateur_agent::exploration_non_informees(QVector<QVector<Salle_manoir>> tableau)
{
